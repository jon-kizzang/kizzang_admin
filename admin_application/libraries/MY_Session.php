...
//require_once (APPPATH.'/libraries/Redis.php');
    ...
    function sess_write()
    {
        ...
        if ($this->sess_use_database == TRUE)
		{
	        $write = $this->CI->redis->multiExec()
	            ...
	            ->execute();
	        if (!$write) log_message('error', 'Failed to write session '.$sess_key);
		}
*/
...
/* Saw an error in the httpd error log on line 342 indicating a problem with the hset, BUT
 * sess_use_database is set to FALSE???
