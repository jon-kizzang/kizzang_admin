...
$token = $_SERVER['OAUTH_QUICKBOOKS_TOKEN'];
...
$oauth_consumer_key = $_SERVER['OAUTH_CONSUMER_KEY'];
$oauth_consumer_secret = $_SERVER['OAUTH_CONSUMER_SECRET'];

// 
// This is the URL of your OAuth auth handler page
//$quickbooks_oauth_url = 'http://quickbooks.v3.com:8888/quickbooks-php/docs/example_app_ipp_v3/oauth.php';
$quickbooks_oauth_url = $_SERVER['PAYMENT_SERVER_URL'].'/quickbooks-php-master/docs/partner_platform/example_app_ipp_v3/oauth.php';

// This is the URL to forward the user to after they have connected to IPP/IDS via OAuth
//$quickbooks_success_url = 'http://quickbooks.v3.com:8888/quickbooks-php/docs/example_app_ipp_v3/success.php';
$quickbooks_success_url = $_SERVER['PAYMENT_SERVER_URL'].'/quickbooks-php-master/docs/partner_platform/example_app_ipp_v3/success.php';
...
$quickbooks_menu_url = $_SERVER['PAYMENT_SERVER_URL'].'/quickbooks-php-master/docs/partner_platform/example_app_ipp_v3/menu.php';

// This is a database connection string that will be used to store the OAuth credentials 
// $dsn = 'pgsql://username:password@hostname/database';
// $dsn = 'mysql://username:password@hostname/database';
//$dsn = 'mysql://kteamdev13:eCdeUQbdHA9L@teamdev.cqq91u91mypw.us-west-1.rds.amazonaws.com/OAuth';			
$dsn = "mysqli://".$_SERVER['RDS_USERNAME'].":".$_SERVER['RDS_PASSWORD']."@".$_SERVER['RDS_HOST']."/OAuth";
...
if ($IntuitAnywhere->check($the_username, $the_tenant))// and IntuitAnywhere->test($the_username, $the_tenant))
{
    ...
    $sandbox_mode = ($_SERVER['USE_SANDBOX'] == false);
    $IPP->sandbox($sandbox_mode);
